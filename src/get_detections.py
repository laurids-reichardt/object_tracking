...
def Object_tracking(Yolo, video_path, input_size=416,
    CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, Track_only=["person"]):
...
Object_tracking(yolo, video_path)

with open('tracked_boxes.pickle', 'wb') as fp:
    pickle.dump(out_tracked_bboxes, fp)